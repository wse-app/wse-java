...
public abstract class AbstractHttpServlet implements HttpCallTreatment {
	...
	/**
	 * Called for all Http Methods. Default implementation is a switch on the Http Method, i.e a GET request is forwarded to the doGet method. 
	 * 
	 * 
	 * @param request The request object. Contains information about the http request.
	 * @param response The response object. Contains logic for making the http response.
	 * @throws IOException
	 * 
	...
	/**
	 * 
	 * Method for handling an http transaction. Called by doAny when the http method is GET.
	 * 
	 * @param request The request object. Contains information about the http request.
	 * @param response The response object. Contains logic for making the http response.
	 * @throws IOException
