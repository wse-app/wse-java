...
public class SSLManager {
	...
	/**
	 * 
	 * Bind the specified HttpCall class to the SSLStore. per-instance bindings have higher priority.
	...
	/**
	 * 
	 * Bind the specified Service to the SSLStore. This is not a permanent binding, and is equivalent to calling service.bindToSSLStore(store);
	 * This does not have any effect on a server.
	 * 
	...
	/**
	 * 
	 * Set the default SSLAuth for all services using WSE. 
	 * This does not have any effect on a server.
	 * 
	 * @param service The service to bind.
	 * @param store The SSLStore to bind to.
	 ...
	 * @return The SSLStore that the specified HttpCall is permanently bound to, or null if it has no binding. 
	 */
