...
public class LocationAnnotator extends XMLFilterImpl {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if (locatorStack.size() > 0) {
			...
			LocationData location = new LocationData(startLocator.getSystemId(), startLocator.getLineNumber(),
					startLocator.getColumnNumber(), locator.getLineNumber(), locator.getColumnNumber());

			elementStack.pop().setUserData(LocationData.LOCATION_DATA_KEY, location, dataHandler);
		}
	}
