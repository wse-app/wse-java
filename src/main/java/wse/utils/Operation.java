...
public class Operation<I extends ComplexType, O extends ComplexType> extends WrappedOperation<I, I, O, O> {
	...
	public Operation(Class<? extends O> wrappedOutputClass, String defaultSoapAction, String defaultURI) {
		super(wrappedOutputClass, defaultSoapAction, defaultURI);
	}

	public Operation(Class<? extends O> wrappedOutputClass, String defaultSoapAction) {
